...
export const BHP = () => {
 ...
 const BarChartBHP = () => {
  ...
  const BarChartNewBHP = () => {
    const data = {
      labels: ['alumno1', 'alumno2', 'alumno3',  'alumno4', 'alumno1', 'alumno2', 'alumno3',  'alumno4','alumno1', 'alumno2', 'alumno3',  'alumno4'],
      datasets: [
        {
          label: '# of Votes',
          data: [4.6, 6, 5.4, 6.5, 5, 7, 4.7, 5.2, 5, 6, 5, 3],
          backgroundColor: [
            'rgba(255,0,0,0.2)',
            'rgba(255,0,0,0.2)',
            'rgba(255,0,0,0.2)',
                  ...
                  <div className="card-header pb-0 pt-3 bg-transparent">
                    <div className="row">
                      <div className="col-md-6">
                        <h6 className="text-capitalize">Número de alumnos por empresa</h6>
