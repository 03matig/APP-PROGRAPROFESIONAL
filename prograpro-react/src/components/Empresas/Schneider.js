...
export const Schneider = () => {
    ...
    const BarChartSchneider = () => {
      ...
      const BarChartNewSchneider = () => {
        const data = {
          labels: ['alumno1', 'alumno2', 'alumno1', 'alumno2', 'alumno1', 'alumno2'],
          datasets: [
            {
              label: '# of Votes',
              data: [4.6, 6, 5.4, 6.5, 5, 6],
              backgroundColor: [
                'rgba(255,0,0,0.2)',
                'rgba(255,0,0,0.2)',
                'rgba(0,255,0,0.2)',
